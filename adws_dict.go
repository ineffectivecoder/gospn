// Code generated from the MC-NBFX static dictionary (via SoaPy). DO NOT EDIT.
//go:build windows

package main

// nbfxStaticDict maps even dictionary indices to their predefined strings
// ([MC-NBFX] / [MC-NBFSE] static string table).
var nbfxStaticDict = map[int]string{
	0x00: "mustUnderstand",
	0x02: "Envelope",
